...
<form:form  method="post" modelAttribute="update_Package">
	...
	<br />
			...
			<div class="row align-items-start">
				...
				<div class="col">
					<form:input path="packageName"  value="${requestScope.old_package.packageName}" required="required" />
				</div>
			</div>
			...
			<div class="row align-items-start">
				...
				<div class="col">
					<form:input path="amount" value="${requestScope.old_package.amount}"  required="required"/>
				</div>
			</div>
	...
	<br />
			...
			<div class="row align-items-start">
				...
				<div class="col">
					<form:input path="duration" value="${requestScope.old_package.duration}"  required="required"/>
				</div>
			</div>
